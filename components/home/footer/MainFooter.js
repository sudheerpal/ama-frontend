...
const MainFooter = () => {
  return (
    <div className="bg-primary">
      <CustomContainer>
        <section className="grid grid-cols-1 gap-8 py-8 text-white md:grid-cols-2 lg:grid-cols-4 lg:py-12 lg:px-12">
          <div className="w-full p-4 space-y-3">
            <Image className="block w-56 mx-auto" src={logo} alt="logo" />
            <p>
              Consulting WP - Before we talk destination, we shine a spotlight
              across your organization to fully understand its people,
              processes, and technology.Consulting WordPress theme / Finance
              WordPress theme / Business WordPress theme
            </p>
          </div>
          <div className="w-full p-4 space-y-3">
