...
const ServiceCard = () => {
  return (
    <div className="relative overflow-hidden transition duration-300 bg-gray-100 shadow-lg hover:shadow-xl">
      ...
      ></div>
      <div className="absolute left-0 right-0 h-full px-4 py-2 text-white transition duration-200 opacity-100 bg-opacity-80 bg-primary top-[200px] backdrop-filter hover:-translate-y-[200px]">
